...
class ClassAdvisorSubmissionContainer extends StatefulWidget {
  final List<QueryDocumentSnapshot<Map<dynamic, dynamic>>>? outpassList;

  const ClassAdvisorSubmissionContainer({super.key, required this.outpassList});

  @override
  State<ClassAdvisorSubmissionContainer> createState() =>
      _ClassAdvisorSubmissionContainerState();
}

class _ClassAdvisorSubmissionContainerState
    extends State<ClassAdvisorSubmissionContainer> {
              ...
              onTap: () async {
                ...
                if (confirm != null && confirm) {
                  while (widget.outpassList != null &&
                    ...
                    await updateAdvisorStatus(document.id, 1);

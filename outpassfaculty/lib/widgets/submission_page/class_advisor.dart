...
class ClassAdvisorSubmissionContainer extends StatefulWidget {
  ...
  @override
  State<ClassAdvisorSubmissionContainer> createState() => _ClassAdvisorSubmissionContainerState();
}

class _ClassAdvisorSubmissionContainerState extends State<ClassAdvisorSubmissionContainer> {
                          ...
                          IconButton(
                            onPressed: () async {
                              ...
                              if (confirm != null && confirm) {
                                ...
                                await updateAdvisorStatus(id, 1);
                                setState(() {

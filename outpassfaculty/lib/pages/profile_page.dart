                  ...
                  SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (userData?['position'] == 'Faculty - Class Advisor') InfoCard(label: "Section", detail: userData?['section']),
                        if (userData?['position'] == 'Faculty - Class Advisor' || userData?['position'] == 'Faculty - HoD') InfoCard(label: "Year", detail: userData?['year']),
                      ],
                    ),
                  ),
                  const SizedBox(height: 10,),

...
class _OutpassPageState extends State<OutpassPage> {
  ...
  String timeIntervalErr = 'Invalid time interval. It should be at least 5 minutes.';
  String dateTimeErr = 'Invalid out-date-time and in-date-time.';
...
Are you sure to proceed?
                ...
                SmallButton(
                  ...
                  onTap: () async {
                    ...
                    await FirestoreService().saveOutpassDetails(context, outpassDetails);
                  }
                )
              ],
            ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SmallButton(name: 'Submit', onTap: () async {
